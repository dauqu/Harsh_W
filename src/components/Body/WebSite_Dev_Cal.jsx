      ...
      <div>
        ...
        >
          <div className="text-center p-16 text-white">
            <div>
              <h1 className="font-bold text-[50px] leading-[60px]">
                Website Development
              </h1>
              <div className="flex_ic font-bold text-[15px] leading-[26px]">
               
                <div className="text-[white] text-[18px]  md:mt-12 mt-4 cursor-pointer">
                  <a href="/">&nbsp;Choose your desireable technologies and calculate the estimated budget of your website.</a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Build your next Vue.js application with confidence using
                        Nuxt
                      </div>
                    </div>
                  </label>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Svelte is a compiler that generates minimal and highly
                        optimized JavaScript code from our sources
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Blitz.js is an up-and-coming JavaScript framework built
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        A JavaScript library for building user interfaces.Hexo
                        is a fast, simple & powerful blog framework powered by
                        Node.js.
                      </div>
                    </div>
                  </label>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        Jekyll. Written in JavaScript. Transforms a directory of
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        An optimized site generator in React. Docusaurus helps
                        you to move fast and write content. Build documentation
                        websites, blogs, marketing pages, and more.
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Preact is a fast 3kB alternative to React with the same
                        modern API.
                      </div>
                    </div>
                  </label>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        SolidStart is considered a meta-framework (a framework
                        built on top of another framework) because, at it's
                        core, SolidStart is powered by SolidJS and the Solid .
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        A JavaScript toolkit that saves you time and scales with
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Vue.js lets you extend HTML with HTML attributes called
                        directives. Vue.js directives offers functionality to
                        HTML applications.
                      </div>
                    </div>
                  </label>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Ionic is a framework that allows us to develop mobile
                        apps and websites using web technologies – HTML, CSS and
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        the free, open source SDK powering millions of
                        mission-critical apps all over the world.
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Enjoy a modern development stack. Build websites with
                        modern tools like Vue.js, webpack and Node.js.
                      </div>
                    </div>
                  </label>
                </li>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        next.js-like conventional routing and various advanced
                        routing functions, such as routing-level on-demand
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Sapper is the companion component framework to Svelte
                        that helps you build larger and more complex apps in a
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Saber is a simple yet powerful framework for building
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Stencil was created to power the components for Ionic
                        Framework - a cross-platform mobile development
                        technology stack used by more than 5M developers
                        worldwide
                      </div>
                    </div>
                  </label>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        generators. With its amazing speed and flexibility
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Jekyll takes your content, renders Markdown and Liquid
                        templates, and spits out a complete, static website
                        ready to be served by Apache, Nginx or another web
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Brunch builds, lints, compiles, concatenates and shrinks
                        your HTML5 app in an ultra-simple way. No more Grunt /
                        Gulp mess
                      </div>
                    </div>
                  </label>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        handles transpiling JavaScript, JSX, and TypeScript. On
                        top of SWC, Parcel implements dependency collection
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Sanity is the platform for structured content that lets
                        your team work together in real-time to build engaging
              ...
              <ul className="w-full h-[80vh] overflow-y-scroll my-10">
                <li
                  ...
                  onClick={function () {
                    ...
                    document.getElementsByClassName("backend_chosen")[0].value =
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        programming languages such as Java, C, C++, PHP, etc.
                      </div>
                    </div>
                  </label>
                </li>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        big data processing, embedded systems,
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        With robust content management tools, sophisticated APIs
                        for multichannel publishing, and a track record of
                        continuous innovation—Drupal is the best digital
                      </div>
                    </div>
                  </label>
                </li>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        language. Rust emphasizes performance, type safety, and
                        concurrency
                      </div>
                    </div>
                  </label>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        small footprint, built for developers who need a simple
                        and elegant toolkit to create full-featured web
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        A web-app framework that includes everything needed to
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        as a framework of frameworks because it provides support
                        to various frameworks such as Struts, Hibernate
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        A free shopping cart system. OpenCart is an open source
                        PHP-based online e-commerce solution.
                      </div>
                    </div>
                  </label>
                </li>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        classified as a microframework because it does not
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Node.js is an open source server environment. Node.js
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        open-source content management system (CMS) written in
                        hypertext preprocessor language and paired with a MySQL
                      </div>
                    </div>
                  </label>
                </li>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        system (RDBMS). MySQL is free and open-source. MySQL is
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        MariaDB Server is one of the most popular open source
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        broker. Redis provides data structures
                      </div>
                    </div>
                  </label>
                </li>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        speed, scale, and relevance it's transforming how the
                        world uses data.
                      </div>
                    </div>
                  </label>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        that combines native graph storage, advanced security,
                        scalable speed-optimized architecture, and ACID
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        CouchDB is also a clustered database that allows you to
                        run a single logical database server on any number of
                        servers or VMs. A CouchDB cluster improves on the
                      </div>
                    </div>
                  </label>
                </li>
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        ...
                        open-source, scalable database that makes building
                      </div>
                    </div>
                  </label>
                </li>
                ...
                >
                  ...
                  >
                    <div className="block">
                      ...
                      <div className="w-full text-sm">
                        Couchbase is an award-winning distributed NoSQL cloud
                        database that delivers unmatched versatility,
                        performance, scalability, and financial value for all of
                      </div>
                    </div>
                  </label>
                </li>
              ...
              <div className="md:flex mt-7">
                <div className="md:w-[380px] px-5">
                  <button
                    ...
                    onClick={function () {
                      var frontend_price =
                        document.getElementsByClassName("frontend_price")[0];
                      var backend_price =
                        document.getElementsByClassName("backend_price")[0];
                      var database_price =
                        document.getElementsByClassName("database_price")[0];
                      var web_type_price =
                        document.getElementsByClassName("web_type_price")[0];
                      var number_of_pages_count =
                        document.getElementsByClassName(
                          "number_of_pages_count"
                        )[0];
                      var total_estimate =
                        document.getElementsByClassName("total_estimate")[0];
